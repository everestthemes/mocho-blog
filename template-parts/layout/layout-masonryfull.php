<?php
/**
 * Template part for displaying posts in masonry full
 *
            ...
            if( $i < 2 ) {
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class("box first_article matchheight"); ?>>
                    ...
                    <div class="post-thumb imghover">
                        <a href="<?php esc_url( the_permalink() ); ?>"><?php the_post_thumbnail( 'mocho-blog-thubmnail-1', array( 'alt' => the_title_attribute( array( 'echo' => false ) ) ) ); ?></a>
