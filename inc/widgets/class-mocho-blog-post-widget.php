...
class Mocho_Blog_Post_Widget extends WP_Widget {
 
    function __construct() { 

        parent::__construct(
            'mocho-blog-post-widget',  // Base ID
            esc_html__( 'MB: Posts Widget', 'mocho-blog' ),   // Name
            array(
                'classname' => 'mb_lastestpost_widget',
                'description' => esc_html__( 'Displays Recent, Most Commented or Editor Picked Posts.', 'mocho-blog' ), 
            )
        ); 
    }
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_name('post_choice') ); ?>">
                <?php esc_html_e('Type of Posts:', 'mocho-blog'); ?>
            </label>
            <select class="widefat" id="<?php echo esc_attr( $this->get_field_id('post_choice') ); ?>" name="<?php echo esc_attr( $this->get_field_name('post_choice') ); ?>">
            	<?php
            		$post_choices = array(
            			'recent' => esc_html__( 'Recent Posts', 'mocho-blog' ),
            			'most_commented' => esc_html__( 'Most Commented', 'mocho-blog' ),
            		);
		...
		<p>
            <label for="<?php echo esc_attr( $this->get_field_name('post_no') ); ?>">
                <strong><?php esc_html_e('No of Popular Posts', 'mocho-blog'); ?></strong>
            </label>
