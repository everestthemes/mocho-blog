                            ...
                            <div class="searchpage_entry">
                                <div class="page_title lined_page_title">
                                	<h2>
										...
										printf( esc_html__( 'Search Results for: %s', 'mocho-blog' ), '<span>' . esc_html( get_search_query() ) . '</span>' );
										?>
									</h2>
                                                        ...
                                                        if( get_post_type() == 'post' ) { 
                                                            ...
                                                            <div class="meta">
                                                                <ul class="post_meta">
                                                                    ...
                                                                    <li class="posted_by"><span><?php esc_html_e( 'By - ', 'mocho-blog' ); ?></span><a href="<?php the_permalink(); ?>"><?php echo esc_html( get_the_author() ); ?></a></li>
                                                                </ul><!-- .post_meta -->
                                                                </ul><!-- .post_meta -->
                                                            </div><!-- .meta -->
                                                            <?php 
